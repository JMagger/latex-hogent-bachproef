...
Bij de hoofdonderzoeksvraag komen er nog meerdere deelvragen bij. Eerst wordt er nagegaan welke Git-branchingstrategieën het meest geschikt zijn voor gebruik binnen de IDz-omgeving van Securex. Vervolgens wordt onderzocht hoe het werken met branches de deploymentprocedures beïnvloedt. Er wordt ook geanalyseerd hoe de codewijzigingen op een gecontroleerde manier doorgevoerd kunnen worden over de verschillende development-, testing- en acceptatieomgevingen. Ook wordt er onderzocht in welke mate het mogelijk is om op het moment te zien welke codeversie in welke omgeving zicht bevindt.
